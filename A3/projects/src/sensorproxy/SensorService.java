 ...
 * 
 */
@WebServiceClient(name = "sensorService", targetNamespace = "http://hawsensor/", wsdlLocation = "http://localhost:1337/?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SENSORSERVICE_QNAME = new QName("http://hawsensor/", "sensorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1337/?WSDL");
     ...
     *     returns Sensor
     */
    @WebEndpoint(name = "sensorPort")
    public Sensor getSensorPort() {
        return super.getPort(new QName("http://hawsensor/", "sensorPort"), Sensor.class);
    }
     ...
     */
    @WebEndpoint(name = "sensorPort")
    public Sensor getSensorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hawsensor/", "sensorPort"), Sensor.class, features);
    }
