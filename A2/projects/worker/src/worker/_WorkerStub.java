...
public class _WorkerStub extends org.omg.CORBA.portable.ObjectImpl implements worker.Worker
{
  ...
  /**
       ...
       */
  public void init (String left, String right, int value, int delay, String monitor, boolean start)
  {
            ...
            try {
                ...
                init (left, right, value, delay, monitor, start        );
            } finally {
                _releaseReply ($in);
            }
  } // init
